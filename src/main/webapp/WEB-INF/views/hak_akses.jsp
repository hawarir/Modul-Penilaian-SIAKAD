                    ...
                    <div class="row">
                        <div class="col-md-4 center">
                            <div class="login-box">
                                ...
                                <form class="m-t-md" method="post" action="${pageContext.servletContext.contextPath}/peransubmit">
                                    <div class="form-group">
                                    	<select name="idPeranPengguna" class="form-control" >
                                    		<c:forEach items="${listPeranPengguna}" var="peranPengguna">
                                    			<option value="${peranPengguna.idPeranPengguna}">${peranPengguna.peran.namaPeran} ${peranPengguna.satMan.nmSatMan}</option>
                                    		</c:forEach>
                                    	</select>
